...
for (n in sample_sizes) {
  ...
  for (i in 1:N) {
    ...
    tests <- list(
      ...
      robust_gradient_statistic(fit_lsmle_h1$score, fit_lsmle$theta_hat, beta[2], fit_lsmle_h1$Vq$H, fit_lsmle$Vq$J, c(2)),
      robust_gradient_statistic(fit_lmdpde_h1$score, fit_lmdpde$theta_hat, beta[2], fit_lmdpde_h1$Vq$H, fit_lmdpde$Vq$J, c(2)),
  ...
  # Save results as txt
  file_name <- paste0("G:/Meu Drive/03 - Sim/03_case_study_1/Results/ScenarioA_NoCont_n", n, ".txt")
